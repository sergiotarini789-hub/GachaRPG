...
/// Runtime state (cooldowns) lives on <see cref="HeroInstance"/>, not here -
/// keep this asset free of mutable battle data so it can be shared.
/// </summary>
...
public class SkillData : ScriptableObject
{
    ...
    /// <summary>What performing the skill does.</summary>
